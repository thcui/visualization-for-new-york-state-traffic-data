...
```
From the plots above, we can see there are more busy streets from New York City(NYC) from 2018 to 2020, and it turns out that the 15 busiest streets are all from NYC on 2020. This suggest us that there may be something different between NYC and other counties, and we should take a closer look to NYC in the further analysis.
